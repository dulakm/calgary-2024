...
const kubernetesProvider = new kubernetes.Provider("gke-cluster-provider", {
...
const ipAddress = new gcp.compute.GlobalAddress("hello-world", {
    project: project.projectId,
});
